...
def plot_training_curves(base_dir, env_name, success_threshold):
    algorithms = ['vcse=False', 'vcse=True', 'vae-vcse=True', 'rv-vcse=True']
    colors = ['black', 'blue', 'green', 'red']
    labels = ['SE', 'VCSE', 'rVCSE', 'AJER']
    ...
    plt.savefig(f'{env_name}_ablation_eval_curves.png')
    plt.show()


base_dir = 'exp_fixed/cartpole_swingup_ablation'
